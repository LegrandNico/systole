...
plot_evoked(
    rr=peaks, triggers_idx=triggers_idx, input_type="peaks", ax=axs[1], **plot_args
)

# Using the list of epochs arrays
plot_evoked(epochs=hr_epochs, ax=axs[2], **plot_args)
...
raw_plot = plot_evoked(
    signal=ecg_df.ecg.to_numpy(), triggers_idx=triggers_idx, modality="ecg", **plot_args
)
